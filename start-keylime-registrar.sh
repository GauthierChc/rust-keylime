...
# Run docker-compose
echo "Running docker-compose-registrar"
docker-compose -f docker-compose-registrar.yml up --build

# Check if docker-compose was successful
if [ $? -ne 0 ]; then
    echo "docker-compose-registrar failed. Check docker-compose.yml configuration."
    exit 1
fi
